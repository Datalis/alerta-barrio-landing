...
export default function BenefitsSection2() {
    return (
        <div className="py-14 z-10 relative">
            ...
            <div className="flex lg:flex-row flex-col items-center gap-20 mt-10">
                ...
                <span className="hidden lg:block bg-black px-8 py-3 rounded-2xl text-white text-lg font-[500] leading-tight">
            ...
            <div className="hidden lg:grid grid-cols-[1fr_2fr_1fr] mt-10">
