...
export default function BenefitsSection1() {
    return (
        <div className="py-14 w-full flex flex-col items-center z-10 relative">
            <SectionTitle>
                <span className="font-[500] hidden lg:inline">Beneficios de <em className="font-[900] italic text-white">Alerta Barrio</em></span>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-[2fr_1fr] gap-x-10 mt-20 ">
                <div className="flex flex-col items-center lg:items-start">
                    ...
                    <div className="lg:bg-black rounded-xl lg:text-white px-5 py-3 mt-5 font-[500] leading-tight">
