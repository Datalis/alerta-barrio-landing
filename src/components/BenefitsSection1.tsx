...
export default function BenefitsSection1() {
    return (
        <div className="py-14 w-full flex flex-col items-center z-10 relative">
            <SectionTitle>
                <span className="font-[500] hidden md:inline">Beneficios de <em className="font-[900] italic text-white">Alerta Barrio</em></span>
                <span className="font-[500] md:hidden leading-tight flex flex-col items-center">Beneficios de <br /> <em className="font-[900] italic text-white">Alerta Barrio</em></span>
            </SectionTitle>
            <div className="grid grid-cols-1 md:grid-cols-[2fr_1fr] gap-x-10 mt-20 ">
                <div className="flex flex-col items-center md:items-start">
                    <Image src={Step1Image} alt="step1" width={150} />
                    <div className="bg-black md:bg-transparent rounded-xl text-white md:text-black md:p-0 mt-5 px-8 py-3">
                        <span className="font-[500] mt-5 leading-tight text-white">El sistema de seguridad de Alerta Barrio está <br />
                            diseñado para que actives una alarma en segundos: </span>
                    </div>
                    <div className="md:bg-black rounded-xl md:text-white px-5 py-3 mt-5 font-[500] leading-tight">
                        Solo abres la aplicación, presionas <br className="hidden md:inline" />
                        un botón … ¡y eso es todo!
                    </div>
                    <div className="grid grid-cols-2 grid-rows-3 gap-x-10 md:gap-y-4 md:ml-auto md:mr-20 mt-5 md:mt-28 font-[500]">
                ...
                <div className="self-end md:w-auto mt-10 w-[200px] justify-self-center">
